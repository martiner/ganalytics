...
public class UTMZTest {
	...
	public void direct() throws CookieParseException {
		UTMZ utmz = new UTMZ(new Cookie(UTMZ.COOKIE_NAME, "114442907.1315070575.1.1.utmccn=(direct)|utmcsr=(direct)|utmcmd=(none)"));
	...
	public void organic() throws CookieParseException {
		UTMZ utmz = new UTMZ(new Cookie(UTMZ.COOKIE_NAME, "114442907.1327488330.1.1.utmccn=(organic)|utmcsr=google|utmctr=magvia|utmcmd=organic"));
		assertEquals("114442907", utmz.getDomainNameHash());
	...
	public void referral() throws CookieParseException {
		UTMZ utmz = new UTMZ(new Cookie(UTMZ.COOKIE_NAME, "114442907.1327488399.1.1.utmccn=(referral)|utmcsr=slatina.macroware.cz|utmcct=/magvia.jsp|utmcmd=referral"));
		assertEquals("114442907", utmz.getDomainNameHash());
	...
	public void cpc() throws CookieParseException {
		UTMZ utmz = new UTMZ(new Cookie(UTMZ.COOKIE_NAME, "129313107.1327488555.1.1.utmcsr=google|utmccn=vk_vk%20-%20csob%20pojistovna%20S_csob%20pojistovna|utmcmd=cpc|utmctr=%C4%8Dsob%20poji%C5%A1%C5%A5ovna|utmcct=online"));
